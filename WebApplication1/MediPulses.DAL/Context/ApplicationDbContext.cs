...
namespace MediPulses.DAL.Context;
...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ConsumptionRecord>(entity =>
        {
            ...
            entity.Property(e => e.Timestamp).HasDefaultValueSql("(getdate())").HasColumnType("datetime");
            entity.Property(e => e.WardId).HasMaxLength(50).HasColumnName("WardID");
            entity.HasOne(d => d.Facility).WithMany(p => p.ConsumptionRecords)
                .HasForeignKey(d => d.FacilityId).HasConstraintName("FK__Consumpti__Facil__6B24EA82");
            entity.HasOne(d => d.Item).WithMany(p => p.ConsumptionRecords)
                .HasForeignKey(d => d.ItemId).HasConstraintName("FK__Consumpti__ItemI__6C190EBB");
            entity.HasOne(d => d.UsedByNavigation).WithMany(p => p.ConsumptionRecords)
                .HasForeignKey(d => d.UsedBy).HasConstraintName("FK__Consumpti__UsedB__6D0D32F4");
        });
        ...
        modelBuilder.Entity<ExceptionEvent>(entity =>
        {
            ...
            entity.Property(e => e.DetectedDate).HasDefaultValueSql("(getdate())").HasColumnType("datetime");
        ...
        modelBuilder.Entity<Forecast>(entity =>
        {
            ...
            entity.Property(e => e.GeneratedDate).HasDefaultValueSql("(getdate())").HasColumnType("datetime");
            entity.Property(e => e.ItemId).HasColumnName("ItemID");
            entity.Property(e => e.Period).HasMaxLength(50);
            entity.HasOne(d => d.Facility).WithMany(p => p.Forecasts)
                .HasForeignKey(d => d.FacilityId).HasConstraintName("FK__Forecast__Facili__7E37BEF6");
            entity.HasOne(d => d.Item).WithMany(p => p.Forecasts)
                .HasForeignKey(d => d.ItemId).HasConstraintName("FK__Forecast__ItemID__7D439ABD");
        });
        ...
        modelBuilder.Entity<InventoryPosition>(entity =>
        {
            ...
            entity.Property(e => e.FacilityId).HasColumnName("FacilityID");
            entity.Property(e => e.ItemId).HasColumnName("ItemID");
            entity.Property(e => e.LotId).HasMaxLength(50).HasColumnName("LotID");
            ...
            entity.HasOne(d => d.Facility).WithMany(p => p.InventoryPositions)
                .HasForeignKey(d => d.FacilityId).HasConstraintName("FK__Inventory__Facil__619B8048");
            entity.HasOne(d => d.Item).WithMany(p => p.InventoryPositions)
                .HasForeignKey(d => d.ItemId).HasConstraintName("FK__Inventory__ItemI__6383C8BA");
            entity.HasOne(d => d.Zone).WithMany(p => p.InventoryPositions)
                .HasForeignKey(d => d.ZoneId).HasConstraintName("FK__Inventory__ZoneI__628FA481");
        });
        ...
        modelBuilder.Entity<Notification>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Notifications)
                .HasForeignKey(d => d.UserId).HasConstraintName("FK__Notificat__UserI__05D8E0BE");
        });
        ...
        modelBuilder.Entity<PurchaseOrder>(entity =>
        {
            ...
            entity.HasOne(d => d.Supplier).WithMany(p => p.PurchaseOrders)
                .HasForeignKey(d => d.SupplierId).HasConstraintName("FK__PurchaseO__Suppl__59063A47");
        });
        ...
        modelBuilder.Entity<RecallAction>(entity =>
        {
            ...
            entity.HasOne(d => d.Exception).WithMany(p => p.RecallActions)
                .HasForeignKey(d => d.ExceptionId).HasConstraintName("FK__RecallAct__Excep__797309D9");
            entity.HasOne(d => d.Owner).WithMany(p => p.RecallActions)
                .HasForeignKey(d => d.OwnerId).HasConstraintName("FK__RecallAct__Owner__7A672E12");
        });
        ...
        modelBuilder.Entity<Receipt>(entity =>
        {
            ...
            entity.HasOne(d => d.Po).WithMany(p => p.Receipts)
                .HasForeignKey(d => d.Poid).HasConstraintName("FK__Receipt__POID__5CD6CB2B");
            entity.HasOne(d => d.ReceivedByNavigation).WithMany(p => p.Receipts)
                .HasForeignKey(d => d.ReceivedBy).HasConstraintName("FK__Receipt__Receive__5EBF139D");
        });
        ...
        modelBuilder.Entity<ReplenishmentPlan>(entity =>
        {
            ...
            entity.HasOne(d => d.Facility).WithMany(p => p.ReplenishmentPlans)
                .HasForeignKey(d => d.FacilityId).HasConstraintName("FK__Replenish__Facil__02FC7413");
            entity.HasOne(d => d.Item).WithMany(p => p.ReplenishmentPlans)
                .HasForeignKey(d => d.ItemId).HasConstraintName("FK__Replenish__ItemI__02084FDA");
        });
        ...
        modelBuilder.Entity<StorageZone>(entity =>
        {
            ...
            entity.HasOne(d => d.Facility).WithMany(p => p.StorageZones)
                .HasForeignKey(d => d.FacilityId).HasConstraintName("FK__StorageZo__Facil__52593CB8");
        });
        ...
        modelBuilder.Entity<TelemetryRecord>(entity =>
        {
            ...
            entity.HasOne(d => d.Sensor).WithMany(p => p.TelemetryRecords)
                .HasForeignKey(d => d.SensorId).HasConstraintName("FK__Telemetry__Senso__72C60C4A");
        });
        ...
        modelBuilder.Entity<TransferOrder>(entity =>
        {
            ...
            entity.HasOne(d => d.FromFacility).WithMany(p => p.TransferOrderFromFacilities)
                .HasForeignKey(d => d.FromFacilityId).HasConstraintName("FK__TransferO__FromF__66603565");
            entity.HasOne(d => d.Item).WithMany(p => p.TransferOrders)
                .HasForeignKey(d => d.ItemId).HasConstraintName("FK__TransferO__ItemI__68487DD7");
            entity.HasOne(d => d.ToFacility).WithMany(p => p.TransferOrderToFacilities)
                .HasForeignKey(d => d.ToFacilityId).HasConstraintName("FK__TransferO__ToFac__6754599E");
        });
